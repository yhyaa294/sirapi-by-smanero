    ...
    <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link href="/" className="flex-shrink-0 flex items-center">
              <span className="text-xl font-bold text-blue-600">SiRapi</span>
            </Link>
            <nav className="hidden md:ml-10 md:flex md:space-x-8">
              ...
              <Link href="/#benefits" className="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
                Manfaat
              </Link>
              <Link href="/#technology" className="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
                Teknologi
              </Link>
            </nav>
          </div>
      ...
      <div className="hidden md:hidden" id="mobile-menu">
        <div className="pt-2 pb-3 space-y-1">
          ...
          <Link href="/#benefits" className="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300">
            Manfaat
          </Link>
          <Link href="/#technology" className="block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300">
            Teknologi
          </Link>
